<?php
  ...
  class Ruckusing_Adapter_MySQL_Base extends Ruckusing_Adapter_Base implements Ruckusing_Adapter_Interface {
    ...
    public function multi_query($queries) {
      ...
      if ( $this->isError($res) ) {
        throw new Ruckusing_Exception(sprintf("Error executing 'query' with:\n%s\n\nReason: %s\n\n", $queries, $this->conn->error), Ruckusing_Exception::QUERY_ERROR);
      }
    ...
    public function add_timestamps($table_name, $created_column_name, $updated_column_name) {
      ...
      $updated_at = $this->add_column($table_name, $updated_column_name, "timestamp", [ "null"    => false,
